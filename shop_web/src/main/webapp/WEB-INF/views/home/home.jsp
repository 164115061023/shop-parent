    ...
    <div class="am-container header">
        ...
        <ul class="message-r">
            ...
            <div class="topMessage my-shangcheng">
                ...
                <div class="menu-hd MyShangcheng"><a href="/person/index?userLoginId=${id}" target="_top"><i class="am-icon-user am-icon-fw"></i>个人中心</a></div>
...
<script src="/static/basic/js/jquery.min.js ">
