						...
						<div class="wrap-list">
							<div class="m-user">
								...
								<div class="m-userinfo">
									<div class="m-baseinfo">
										<a href="personal_data/information.jsp">
									...
									<div class="m-right">
										<div class="m-new">
											<a href="my_nest/news.jsp"><i class="am-icon-bell-o"></i>消息</a>
										</div>
										<div class="m-address">
											<a href="personal_data/address.jsp" class="i-trigger">我的收货地址</a>
										</div>
									</div>
								</div>
							...
							<div class="m-order">
								<div class="s-bar">
									...
									<a class="i-load-more-item-shadow" href="order/order.jsp">全部订单</a>
								</div>
								<ul>
									<li><a href="order/order.jsp"><i><img src="/static/images/pay.png"/></i><span>待付款</span></a></li>
									<li><a href="order/order.jsp"><i><img src="/static/images/send.png"/></i><span>待发货<em class="m-num">1</em></span></a></li>
									<li><a href="order/order.jsp"><i><img src="/static/images/receive.png"/></i><span>待收货</span></a></li>
									<li><a href="order/order.jsp"><i><img src="/static/images/comment.png"/></i><span>待评价<em class="m-num">3</em></span></a></li>
									<li><a href="order/change.html"><i><img src="/static/images/refund.png"/></i><span>退换货</span></a></li>
								</ul>
							</div>
							<!--九宫格-->
							<div class="user-patternIcon">
								...
								<ul>
									...
									<a href="my_nest/collection.jsp"><li class="am-u-sm-4"><i class="am-icon-heart am-icon-md"></i><img src="/static/images/iconsmall1.png"/><p>我的收藏</p></li></a>
									...
									<a href="my_nest/comment.jsp"><li class="am-u-sm-4"><i class="am-icon-pencil am-icon-md"></i><img src="/static/images/iconsmall3.png"/><p>好评宝贝</p></li></a>
									<a href="my_nest/foot.jsp"><li class="am-u-sm-4"><i class="am-icon-clock-o am-icon-md"></i><img src="/static/images/iconsmall2.png"/><p>我的足迹</p></li></a>
								</ul>
							</div>
							<!--物流 -->
										...
										<li class="lg-item">
											...
											<div class="lg-info">
												...
												<div class="lg-detail-wrap">
													<a class="lg-detail i-tip-trigger" href="order/logistics.jsp">查看物流明细</a>
