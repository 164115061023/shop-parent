...
<head>
    ...
    <link href="/static/css/blstyle.css" rel="stylesheet" type="text/css">
...
<div class="center">
                    ...
                    <div class="module-income ng-scope">
                        <div class="income-slider ">
                            ...
                            <h3 class="expense income-title block-title">
                                ...
                                <span class="desc ng-binding">
                                           <a href="/person/myassets/billlist">查看收入明细</a>
                                    </span>
                            </h3>
                        </div>
                                ...
                                <div class="cards-carousel">
                                    <div class="mask">
                                        ...
                                        <div class="bank ng-binding"
                                             style="background-image: url(/static/images/combo.png);">中国农业银行
                                        </div>
                                        <div class="details">
                                            <a>查看详情</a>
                                        </div>
                                ...
                                <div class="cards-details">
                                    <div class="bank-name">
                                        <div class="name fn-left"
                                             style="background-image: url(/static/images/combo.png);"></div>
    ...
    <jsp:include page="../left/left.jsp">
        <jsp:param name="menu" value="bill"/>
    </jsp:include>
</div>
