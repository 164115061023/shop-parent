								...
								<div class="am-tab-panel am-fade" id="tab2">
									<!--消息 -->
										<div class="s-msg-item s-msg-temp i-msg-downup">
											...
											<div class="s-msg-content i-msg-downup-wrap">
												<div class="i-msg-downup-con">
													<a class="i-markRead" target="_blank" href="../order/logistics.jsp">
													<div class="m-item">	
														<div class="item-pic">															
								...
								<div class="am-tab-panel am-fade" id="tab3">
									<!--消息 -->
										<div class="s-msg-item s-msg-temp i-msg-downup">
											...
											<div class="s-msg-content i-msg-downup-wrap">
												<div class="i-msg-downup-con">
													<a class="i-markRead" target="_blank" href="../order/record.jsp">
													<div class="m-item">	
														<div class="item-pic">															
																	<img src="../images/kouhong.jpg_80x80.jpg" class="itempic J_ItemImg">
														</div>
													...
													<p class="s-row s-main-content">
															<a href="../order/record.jsp">钱款去向</a> <i class="am-icon-angle-right"></i>
													</p>
													</a>
												</div>
											</div>
			...
			<aside class="menu">
				<ul>
					...
					<li class="person">
						<a href="#">我的交易</a>
						<ul>
							<li><a href="../order/order.jsp">订单管理</a></li>
							<li> <a href="../order/change.html">退款售后</a></li>
						</ul>
					</li>
					<li class="person">
						<a href="#">我的资产</a>
